...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 25, random_state = 153)

# Тренировка
regr = RandomForestRegressor(n_estimators = 10, max_depth = 10, random_state = 153)
